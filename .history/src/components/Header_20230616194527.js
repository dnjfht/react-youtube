  ...
  return (
    ...
    >
      <div
        ...
        } lg:w-4/6 h-[100%] mx-auto flex flex-row items-center justify-between p-2 pr-[36]px box-border border-solid border-b-[1px]`}
      >
        <div
        ...
        >
          <div className="relative xl:w-[88%]">
            ...
            <input
              ...
              className={`${
                appear
                  ? "xl:w-full pl-[3rem] border-[#4a7dff]"
                  : "xl:w-full pl-[1rem] border-[#303030]"
          ...
          <button
            ...
            } xl:w-[12%] h-[2.5rem] px-[1px] py-[6px] rounded-r-full box-border flex flex-row justify-center items-center border-solid border-[1px]`}
