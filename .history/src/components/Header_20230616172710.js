  ...
  return (
    ...
    >
      <div
        ...
        } 2xl:w-4/6 h-[100%] mx-auto flex flex-row items-center justify-between p-2 pr-[36]px box-border border-solid border-b-[1px]`}
      >
        <div
        ...
        <div className="flex flex-row items-center mx-auto 2xl:w-1/2">
          <div className="relative 2xl:w-[84%]">
            <IoIosSearch
              className={`${
                appear ? "block" : "hidden "
          ...
          <button
            ...
            } 2xl:w-[16%] h-[2.5rem] px-[1px] py-[6px] rounded-r-full box-border flex flex-row justify-center items-center border-solid border-[1px]`}
